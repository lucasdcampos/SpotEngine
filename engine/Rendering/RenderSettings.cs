...
public static class RenderSettings
{
    ...
    /// bloom, FXAA, vignette) — so the baseline is the best graphics on offer; adding the component is
    /// for customizing that look, not switching quality on. When off, a scene with no post-processing
